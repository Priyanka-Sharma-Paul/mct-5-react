...
const contactSlice = createSlice({
    ...
    reducers: {
        ...
        updateContact: (state, action) => {
            ...
            fetch(`https://contact-list-app-5222d-default-rtdb.asia-southeast1.firebasedatabase.app/contact-list/${key}.json`,
                {
                    method: "PUT",
                    headers: {
        ...
        fetchTotalContacts: (state, action) => {
            if(action.payload) state.totalContacts = Object.keys(action.payload).length;
